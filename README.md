...
### To drop layers of BERT, XLNet, RoBERTa and DistilBERT

- look at examples/run_glue.py
- specify layers to remove using --remove_layers e.g. you can remove top three layers by mentioning --remove_layers 9,10,11
